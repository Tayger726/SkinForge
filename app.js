...
function marketDataLabel(data){
 ...
 const time=Number.isFinite(stamp)?new Date(stamp).toLocaleString('ru-RU'):'время неизвестно';
 return (data.stale?'Сохранённая копия • ':'' )+(data.updated_at?'Источник обновлён: ':'Получено: ')+time;
}
