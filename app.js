...
function marketComparisonMarkup(s){
 ...
 const rows=[
  {id:'skinport',name:'Skinport',kind:'cash',status:'Цена объявления, не ордер покупателя',price:Number(s.price)||0,fee:8,readonly:true,url:s.itemPage||s.marketPage||'https://skinport.com/market'},
  {id:'steam',name:'Steam Market',kind:'wallet',status:steam?(prices.steam?.price_type||'Средняя продаж')+' • '+marketDataLabel(prices.steam):'Цена временно недоступна',price:steam,fee:15,url:'https://steamcommunity.com/market/listings/730/'+encodeURIComponent(hash)},
  {id:'csfloat',name:'CSFloat',kind:'cash',status:csfloat?'Ордер из сводки • '+marketDataLabel(prices.csfloat):'Цена временно недоступна',price:csfloat,fee:2,url:'https://csfloat.com/'},
